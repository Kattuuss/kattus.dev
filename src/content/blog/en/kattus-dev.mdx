...
[Astro](https://astro.build/) has been the fundamental pillar of this project. Although it was born as a framework optimized for static sites, its evolution has been worthy of study. Today, through its "islands" architecture, it allows injecting dynamism only where it is really necessary. Its greatest asset is, without a doubt, its *"zero-JS"* philosophy: by default, Astro sends zero lines of JavaScript to the browser, which guarantees exceptional performance from the first second.
