...
alt: "post hablando sobre como hice mi proyecto java: linkweaver"
...
banner: ../../../assets/projects/linkweaver/linkweaver.jpg
...
## Descripción general
A mediados de Abril de 2026, recordé el proyecto de un nuevo navegador con motor de búsqueda propio, al que algunos llamaron "El asesino de Google Chrome" ([Ladybird](https://ladybird.org/)). Lo que comenzó como un recuerdo me llevó a buscar información sobre el desarrollo de navegadores y sus motores de búsqueda junto al objetivo de resolver una duda: "¿Cuán difícil es construir un motor de búsqueda desde cero?". Tras un tiempo de investigación identifiqué 7 pilares necesarios para crear un motor de búsqueda que, aunque no competiría con [Google](https://www.google.com) o [DuckDuckGo](https://duckduckgo.com/), sí sería capaz de ofrecer resultados útiles. Estas 7 necesidades son:
...
- **Concurrencia y persistencia:** Al implementar multihilo, me encontré con condiciones de carrera donde el archivo JSON resultante se sobrescribía constantemente. Aprendí a gestionar la escritura de datos mediante [Jackson](https://github.com/FasterXML/jackson), lo que me permitió manejar el objeto de salida de forma segura y estructurada.

- **Limpieza de enlaces:** Descubrí que muchos de los recursos encontrados no eran URLs válidas, sino rutas relativas que no conducían a ninguna parte. Tras investigar la documentación, descubrí que la solución era mucho más sencilla de lo que pensaba: utilizar el método `absUrl()` de [Jsoup](https://jsoup.org/). Este pequeño ajuste resolvió el problema de integridad de datos que me había llevado horas de debugging.
